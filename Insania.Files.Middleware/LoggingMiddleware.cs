...
namespace Insania.Files.Middleware;
...
public class LoggingMiddleware(RequestDelegate next)
{
    ...
    public async Task Invoke(HttpContext context, LogsApiFilesContext contextDB)
    {
        ...
        LogApiFiles log = new("system", true, method, type, request, null);

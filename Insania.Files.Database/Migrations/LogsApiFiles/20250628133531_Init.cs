    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.EnsureSchema(
                name: "insania_logs_api_files");

            migrationBuilder.CreateTable(
                name: "r_logs_api_files",
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_r_logs_api_files", x => x.id);
                },
                comment: "Логи сервиса файлов");

            migrationBuilder.CreateIndex(
                name: "IX_r_logs_api_files_data_in",
                schema: "insania_logs_api_files",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_r_logs_api_files_data_out",
                schema: "insania_logs_api_files",
                table: "r_logs_api_files",
                column: "data_out")
                .Annotation("Npgsql:IndexMethod", "gin");
